...
<a class="text-[var(--text-secondary)] hover:text-[var(--primary-color)] font-medium transition-colors duration-200 ease-in-out" href="#">Home</a>
<a class="text-[var(--primary-color)] font-bold transition-colors duration-200 ease-in-out" href="#">About</a>
...
<div class="space-y-6">
<div>
<h3 class="text-2xl font-bold text-[var(--primary-color)] mb-2 flex items-center"><span class="material-icons mr-2">rocket_launch</span>Mission</h3>
<p class="text-[var(--text-secondary)] text-lg leading-relaxed">To empower aspiring professionals worldwide by providing exceptional training and seamless pathways to successful careers in Japan. We are committed to bridging the gap between global talent and Japanese industries, fostering mutual growth and cultural understanding.</p>
</div>
<div>
<h3 class="text-2xl font-bold text-[var(--primary-color)] mb-2 flex items-center"><span class="material-icons mr-2">visibility</span>Vision</h3>
<p class="text-[var(--text-secondary)] text-lg leading-relaxed">To be the leading and most trusted partner for career development in Japan, recognized for our commitment to quality, integrity, and the long-term success of our students and corporate partners. We envision a future where talent knows no borders.</p>
</div>
</div>
</div>
...
<p class="text-[var(--text-secondary)]">We operate with honesty, transparency, and a strong sense of ethics in all our interactions.</p>
</div>
...
<p class="text-[var(--text-secondary)]">We strive for the highest standards in education and support services, ensuring the best outcomes for our students.</p>
</div>
...
<p class="text-[var(--text-secondary)]">We build strong partnerships with students, companies, and communities to create shared success.</p>
</div>
</div>
</div>
</section>
